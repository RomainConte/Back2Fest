    ...
    <ScrollView style={styles.container}>
        ...
        <Icon
          ...
          onPress={() => navigation.goBack()} 
                /><Text style={{ ...styles.title, marginTop: 59, color: '#121212', fontSize: 23, fontWeight: 'bold', alignSelf: 'center', }}>Jour 4
                </Text>
      </View>
      
      <View style={styles.daysContainer}>
        
    {renderDayBox('Jour 4', '#C15A5A', [
     require('../assets/YOUV DEEE.png'), 
          ...
          require('../assets/LOUS AND THE YAKUZA.png'), 
            require('../assets/OSIRUS JACK.png'), 
            require('../assets/rappeur_nes-2 1.png'), 
          require('../assets/JE NE SAIS PLUS AUSSI.png'), 
            require('../assets/JE NE SAIS PLUS QUI C_EST.png'), 
          require('../assets/PANGA TODD.png'), 
])}
          </View>
