    ...
    <ScrollView style={styles.container}>
        ...
        <Icon
          ...
          onPress={() => navigation.goBack()} 
              /><Text style={{ ...styles.title, marginTop:59 ,color: '#121212', fontSize: 23, fontWeight: 'bold', alignSelf: 'center', }}>Jour 2 </Text>
      </View>
      
      <View style={styles.daysContainer}>
        
    {renderDayBox('Jour 2', '#E4B979', [
      require('../assets/LUIDJI.png'), 
          require('../assets/PLK.png'), 
          require('../assets/LOUS AND THE YAKUZA.png'), 
          require('../assets/site-bushi 2.png'), 
            require('../assets/Houdi 1.png'), 
            require('../assets/THAHOMEY.png'), 
          require('../assets/WERENOI.png'), 
            require('../assets/jazzy-bazz-nekfeu-element-115-duo-feat-memoria-1-1024x750-1 1.png'), 
          require('../assets/WINTERZUKO.png'), 
])}
          </View>
